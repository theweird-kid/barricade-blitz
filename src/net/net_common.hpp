...
struct MessageServer {
  NetID ID; // Unique ID of the reciever
  ...
  void Deserialize(const ENetPacket *packet) {
    memcpy(&ID, packet->data, sizeof(int32_t));
    memcpy(&x_enemy_position, packet->data + sizeof(int32_t), sizeof(int32_t));
    memcpy(&y_enemy_position, packet->data + 2 * sizeof(int32_t), sizeof(int32_t));
    memcpy(&x_enemy_velocity, packet->data + 3 * sizeof(int32_t), sizeof(int32_t));
    memcpy(&y_enemy_velocity, packet->data + 4 * sizeof(int32_t), sizeof(int32_t));
    memcpy(&PlayerScore, packet->data + 5 * sizeof(int32_t), sizeof(int32_t));
    memcpy(&EnemyScore, packet->data + 6 * sizeof(int32_t), sizeof(int32_t));
  }
};
...
struct ClientState {
  ...
  int roomID; // Room ID of the client
